...
WHERE HumanResources.Department.DepartmentID IN 
(
	SELECT HumanResources.EmployeeDepartmentHistory.DepartmentID FROM HumanResources.EmployeeDepartmentHistory
...
-------------------------------------------------------------
SELECT TerritoryID, SUM(CommissionPct) AS CommissionPctSum FROM Sales.SalesPerson
...
-------------------------------------------------------------
SELECT * FROM HumanResources.Employee AS Employee
FULL JOIN PurchASing.PurchASeOrderHeader ON PurchASing.PurchASeOrderHeader.EmployeeID = Employee.BusinessEntityID
GO
